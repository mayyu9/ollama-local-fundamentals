...
# file_path = "./data/JavaScript_useful_resources.pdf"
# file_path = "./data/Building_Intelligent_AI_Agents.pdf"
file_path = "./data/Goechala.pdf"
...
# res = chain.invoke(input=("can you provide the detailed itinerary",))


res = chain.invoke(input=("highlights of this trek",))
